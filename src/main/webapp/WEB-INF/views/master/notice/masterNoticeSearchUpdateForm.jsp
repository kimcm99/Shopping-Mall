...
<div class="container" align="center">
		...
		method="post" enctype="multipart/form-data">
			...
			<table class="table table-hover">
				<tr>
					<td>제목</td>
					<td><input type="text" size="52" maxlength="50" name="mnTitle" id="mnTitle" value="${mn.mnTitle }"></td>
				</tr>
				<tr>
					<td>첨부파일</td>
				...
				<td colspan="2">
				<img
				src="images/${mn.mnOriFile}">
				</tr>
				<tr>
					<td>내용</td>
					<td><pre><textarea cols="50" rows="10" name="mnContent" id="mnContent">${mn.mnContent }</textarea></pre></td>
				</tr>
				<tr>
					<td colspan="2">
